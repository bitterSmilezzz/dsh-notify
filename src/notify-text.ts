...
export const ZH_NOTIFY_TEXT: NotifyText = {
  turnTitle: '轮次完成',
...
/** 英文文案。 */
export const EN_NOTIFY_TEXT: NotifyText = {
...
/** 全部字典（按 locale id 索引）。 */
export const NOTIFY_TEXTS: Record<NotifyLocale, NotifyText> = {
  zh: ZH_NOTIFY_TEXT,
  en: EN_NOTIFY_TEXT,
}
 ...
 */
export function notifyTextOf(preference: unknown): NotifyText {
  if (typeof preference !== 'string') return ZH_NOTIFY_TEXT
