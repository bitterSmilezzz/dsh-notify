...
import { approvalDetailOf, errorDedupKey, isSubagent, NOTIFY_EVENTS, pruneExpired, sessionLabelOf, summaryOf } from './notify-policy.ts'
...
export function applySystemNotify(
  ...
  const textOf = (): NotifyText => notifyTextOf(preferenceOf())
