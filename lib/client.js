		...
		function LegacyCardShell({ t, children }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: "dshn-chevron" + (open ? " dshn-open" : "") })]
		...
		*/
		function applyPresenceReporting(ctx) {
			ctx.inject(["connection"], (connectionCtx) => {
				...
				if (typeof connection?.rpc?.call !== "function" || connection === void 0) return;
				connectionCtx.effect(() => {
					...
					const report = (visible) => {
						try {
							connection.rpc.call(CHANNEL, ENDPOINT, { visible }).catch(() => {});
						} catch {}
					};
